          ...
          items && items.map((item, index) => (
            <li key={item.id} className="list-none mb-4 border w-72 bg-white shadow rounded hover:shadow-xl flex flex-col">
              <a href={`${item.linkUrl.replace('http', 'https')}`} target="_blank">
                ...
                <h2 className="p-2 border-t text-sm font-notosanskr">{item.goodsName}</h2>
              </a>
              <div className="mt-auto">
                ...
                <div className="flex justify-around items-center bg-pink-100 text-gray-900 text-sm font-exo2">
